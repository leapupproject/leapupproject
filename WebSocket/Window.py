...
class Window(threading.Thread):
    ...
    def run(self):
        ...
        self.display = pygame.display.set_mode((self.screen_x,
                self.screen_y), pygame.FULLSCREEN)
    ...
    def drawGraph(self, vector, label):
        ...
        pygame.draw.circle(self.world, GREEN, (int(self.time),
                           int(vector[0] * self.sc) + 1 + 300), 2)
        pygame.draw.circle(self.world, RED, (int(self.time),
                           int(vector[1] * self.sc) + 300), 2)
        pygame.draw.circle(self.world, YELLOW, (int(self.time),
                           int(vector[2] * self.sc) + 1 + 300), 2)
        ...
        scalaLabel = self.myfont.render('scala:' + str(self.sc), 2,
                WHITE)
        ...
        self.display.blit(text, (self.screen_x * 0.9, self.screen_y
                          * 0.1))
 
        self.display.blit(xLabel, (self.screen_x * 0.9, self.screen_y
                          * 0.5))
        pygame.draw.rect(self.display, GREEN,
                         pygame.Rect((self.screen_x * 0.9 + 20,
                         self.screen_y * 0.5 + 5), (10, 10)))
 
        self.display.blit(yLabel, (self.screen_x * 0.9, self.screen_y
                          * 0.52))
        pygame.draw.rect(self.display, RED, pygame.Rect((self.screen_x
                         * 0.9 + 20, self.screen_y * 0.52 + 5), (10,
                         10)))
 
        self.display.blit(zLabel, (self.screen_x * 0.9, self.screen_y
                          * 0.54))
        pygame.draw.rect(self.display, YELLOW,
                         pygame.Rect((self.screen_x * 0.9 + 20,
                         self.screen_y * 0.54 + 5), (10, 10)))
 
        self.display.blit(scalaLabel, (self.screen_x * 0.9,
                          self.screen_y * 0.1 + 20))
 
        pygame.draw.rect(self.display, BLACK, pygame.Rect((0, 0), (50,
                         1200)))
        for x in range(0, self.screen_y, int(self.scale * self.sc)):
            pygame.draw.line(self.world, LIGHTBLUE, (0, x), (10000, x),
                             1)
